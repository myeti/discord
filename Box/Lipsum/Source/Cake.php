 ...
 */
namespace Discord\Box\Lipsum\Source;

use Discord\Box\Lipsum\SourceDict;

class Cake extends SourceDict
{

    /** @var array */
    protected $dict = ['cupcake', 'ipsum', 'dolor', 'sit', 'amet', 'pudding', 'donut', 'muffin', 'gingerbread', 'sweet',
